class RbenvRuby261 < FPM::Cookery::Recipe

  homepage 'https://www.ruby-lang.org/'
  name 'rbenv-ruby-2.6.1'
  version '1'

  source 'https://cache.ruby-lang.org/pub/ruby/2.6/ruby-2.6.1.tar.gz'
...
Specific version of Ruby for use with a system install of rbenv.'
  ...
  def build
    configure prefix: '/usr/lib/rbenv/versions/2.6.1'
    make
  end
